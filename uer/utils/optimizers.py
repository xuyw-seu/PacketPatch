...
def get_constant_schedule_with_warmup(optimizer: Optimizer, num_warmup_steps: int, last_epoch: int = -1):
    ...
    def lr_lambda(current_step: int):
        """Summary of lr_lambda.
        
        Args:
            current_step (Any): Description.
        Returns:
            Any: Description.
        """
...
class AdamW(Optimizer):
    ...
    def __init__(
        ...
        Args:
            ...
            lr (Any): Description.
            betas (Any): Description.
            eps (Any): Description.
            weight_decay (Any): Description.
            correct_bias (Any): Description.
        """
        if lr < 0.0:
    ...
    *warmup_init* options. To use a manual (external) learning rate schedule you should set `scale_parameter=False` and
    ...
    def __init__(
        ...
        Args:
            ...
            lr (Any): Description.
            eps (Any): Description.
            clip_threshold (Any): Description.
            decay_rate (Any): Description.
            beta1 (Any): Description.
            weight_decay (Any): Description.
            scale_parameter (Any): Description.
            relative_step (Any): Description.
            warmup_init (Any): Description.
        """
    ...
    def _get_options(param_group, param_shape):
        """Summary of _get_options.
        
        Args:
            param_group (Any): Description.
            param_shape (Any): Description.
        Returns:
            Any: Description.
        """
    ...
    def _approx_sq_grad(exp_avg_sq_row, exp_avg_sq_col):
        """Summary of _approx_sq_grad.
        
        Args:
            exp_avg_sq_row (Any): Description.
            exp_avg_sq_col (Any): Description.
        Returns:
            Any: Description.
        """
