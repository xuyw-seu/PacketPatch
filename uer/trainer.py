...
class Trainer(object):
    ...
    def forward_propagation(self, batch, model):
        ...
        """Summary of forward_propagation.
    ...
    def report_and_reset_stats(self):
        ...
        """Summary of report_and_reset_stats.
        """
        raise NotImplementedError
    ...
    def train(self, args, gpu_id, rank, loader, model, optimizer, scheduler):
        ...
        Args:
            args (Any): Description.
            gpu_id (Any): Description.
            rank (Any): Description.
            loader (Any): Description.
            model (Any): Description.
            optimizer (Any): Description.
            scheduler (Any): Description.
        """
        model.train()
