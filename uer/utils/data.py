...
def mask_seq(src, tokenizer, whole_word_masking, span_masking, span_geo_prob, span_max_length):
    ...
    Args:
        src (Any): Description.
        tokenizer (Any): Description.
        whole_word_masking (Any): Description.
        span_masking (Any): Description.
        span_geo_prob (Any): Description.
        span_max_length (Any): Description.
    Returns:
        Any: Description.
    """
...
def get_span_len(max_span_len, p):
    """Summary of get_span_len.
    
    Args:
        max_span_len (Any): Description.
        p (Any): Description.
    Returns:
        Any: Description.
    """
...
def merge_dataset(dataset_path, workers_num):
    # Merge datasets.
    """Summary of merge_dataset.
    
    Args:
        dataset_path (Any): Description.
        workers_num (Any): Description.
    """
...
class Dataset(object):
    ...
    def worker(self, proc_id, start, end):
        ...
        Args:
            proc_id (Any): Description.
            start (Any): Description.
            end (Any): Description.
        """
...
class DataLoader(object):
    def __init__(self, args, dataset_path, batch_size, proc_id, proc_num, shuffle=False):
        ...
        Args:
            ...
            proc_id (Any): Description.
            proc_num (Any): Description.
            shuffle (Any): Description.
        """
...
class BertDataset(Dataset):
    ...
    def build_instances(self, all_documents):
        """Summary of build_instances.
        
        Args:
            all_documents (Any): Description.
        Returns:
            Any: Description.
        """
        instances = []
    ...
    def create_ins_from_doc(self, all_documents, document_index):
        """Summary of create_ins_from_doc.
        
        Args:
            all_documents (Any): Description.
            document_index (Any): Description.
        Returns:
            Any: Description.
        """
...
class MlmDataset(Dataset):
    ...
    def concatenate_docs(self, docs_buffer):
        """Summary of concatenate_docs.
        
        Args:
            docs_buffer (Any): Description.
        Returns:
            Any: Description.
        """
        all_documents = []
