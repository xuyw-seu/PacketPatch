...
class Tokenizer(object):
    ...
    def convert_tokens_to_ids(self, tokens):
        """Summary of convert_tokens_to_ids.
    ...
    def convert_ids_to_tokens(self, ids):
        """Summary of convert_ids_to_tokens.
...
def encode_ids(sp_model, text, sample=False):
    """Summary of encode_ids.
    
    Args:
        sp_model (Any): Description.
        text (Any): Description.
...
class WordpieceTokenizer(object):
    ...
    def __init__(self, vocab, unk_token="[UNK]", max_input_chars_per_word=200):
        ...
        Args:
            vocab (Any): Description.
            unk_token (Any): Description.
            max_input_chars_per_word (Any): Description.
        """
        self.vocab = vocab
