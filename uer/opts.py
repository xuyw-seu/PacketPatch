def model_opts(parser):
    """Summary of model_opts.
    
    Args:
        parser (Any): Description.
    """
...
def finetune_opts(parser):
    ...
    parser.add_argument("--config_path", default=r"D:\project\ET-BERT\ET-BERT-main\models/bert/base_config.json", type=str,
...
def infer_opts(parser):
    ...
    parser.add_argument("--config_path", default="D:\project\ET-BERT\ET-BERT-main\models/bert/base_config.json", type=str,
                        help="Path of the config file.")
